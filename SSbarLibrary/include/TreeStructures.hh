...
struct QQbar_Single_PFO {
  public:
    ...
    Int_t   pfo_piddedx = 0;
    Float_t pfo_piddedx_likelihood = 0;
    Float_t pfo_piddedx_eprob = 0;
    Float_t pfo_piddedx_muprob = 0;
    Float_t pfo_piddedx_piprob = 0;
    Float_t pfo_piddedx_kprob = 0;
    Float_t pfo_piddedx_pprob = 0;
    Float_t pfo_piddedx_hprob = 0;
    Float_t pfo_piddedx_e_dedxdist = 0;
    Float_t pfo_piddedx_mu_dedxdist = 0;
    Float_t pfo_piddedx_pi_dedxdist = 0;
    Float_t pfo_piddedx_k_dedxdist = 0;
    Float_t pfo_piddedx_p_dedxdist = 0;
    Float_t pfo_piddedx_e_lkhood = 0;
    Float_t pfo_piddedx_mu_lkhood = 0;
    Float_t pfo_piddedx_pi_lkhood = 0;
    Float_t pfo_piddedx_k_lkhood = 0;
    Float_t pfo_piddedx_p_lkhood = 0;
    Float_t pfo_pidtof_p_at_calo = 0;
