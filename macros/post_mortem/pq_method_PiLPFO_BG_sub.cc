...
void pq_method_PiLPFO_BG_sub()
{
  try
  {
    ...
    // h_total_reco_sig->Add(h_total_reco_bg,-1.05);
    // h_total_reco_sig->Add(h_total_reco_bg,-1);
    // h_total_reco_sig->Add(h_total_reco_bg,-0.95);
    h_total_reco_sig->Add(h_total_reco_bg,-0.99);
    ...
    // Calc AFB from FB counts
    // TH1F *h_total_reco_fb = (TH1F*) h_total_reco->Clone();
    // TH1F *h_bg_reco_fb    = (TH1F*) h_total_reco_bg->Clone();

    // Float_t Ntot_f = h_total_reco_fb->Integral(11,50);
    // Float_t Ntot_b = h_total_reco_fb->Integral(51,90);
    // cout << "Nf = " << Ntot_f << endl;
    // cout << "Nb = " << Ntot_b << endl;

    // Float_t Nbg_f = h_bg_reco_fb->Integral(11,50);
    // Float_t Nbg_b = h_bg_reco_fb->Integral(51,90);
    // cout << "Nf bg = " << Nbg_f << endl;
    // cout << "Nb bg = " << Nbg_b << endl;

    TH1F *h_sig_reco_fb   = (TH1F*) h_total_reco->Clone();

    TH1F *h_sig_reco_fb_m1 = (TH1F*) h_total_reco->Clone();
    TH1F *h_sig_reco_fb_p1 = (TH1F*) h_total_reco->Clone();

    TH1F *h_sig_reco_fb_m5 = (TH1F*) h_total_reco->Clone();
    TH1F *h_sig_reco_fb_p5 = (TH1F*) h_total_reco->Clone();

    h_sig_reco_fb->Add(h_total_reco_bg,-1);
    h_sig_reco_fb_m1->Add(h_total_reco_bg,-1.01);
    h_sig_reco_fb_p1->Add(h_total_reco_bg,-0.99);
    h_sig_reco_fb_m5->Add(h_total_reco_bg,-1.05);
    h_sig_reco_fb_p5->Add(h_total_reco_bg,-0.95);

    Float_t Nsig_f = h_sig_reco_fb->Integral(51,90);
    Float_t Nsig_b = h_sig_reco_fb->Integral(11,50);
    cout << "Nsig f = " << Nsig_f << endl;
    cout << "Nsig b = " << Nsig_b << endl;

    Float_t AFB_fb = (Nsig_f - Nsig_b) / (Nsig_f + Nsig_b);
    cout << "AFB from FB = " << AFB_fb << endl;

    Float_t Nsig_f_m1 = h_sig_reco_fb_m1->Integral(51,90);
    Float_t Nsig_b_m1 = h_sig_reco_fb_m1->Integral(11,50);

    Float_t Nsig_f_p1 = h_sig_reco_fb_p1->Integral(51,90);
    Float_t Nsig_b_p1 = h_sig_reco_fb_p1->Integral(11,50);

    Float_t Nsig_f_m5 = h_sig_reco_fb_m5->Integral(51,90);
    Float_t Nsig_b_m5 = h_sig_reco_fb_m5->Integral(11,50);

    Float_t Nsig_f_p5 = h_sig_reco_fb_p5->Integral(51,90);
    Float_t Nsig_b_p5 = h_sig_reco_fb_p5->Integral(11,50);

    Float_t AFB_fb_m1 = AFB_N_calculation(Nsig_f_m1, Nsig_b_m1);
    Float_t AFB_fb_p1 = AFB_N_calculation(Nsig_f_p1, Nsig_b_p1);
    cout << "AFB from FB -1% = " << AFB_fb_m1 << endl;
    cout << "AFB from FB +1% = " << AFB_fb_p1 << endl;

    Float_t AFB_fb_m5 = AFB_N_calculation(Nsig_f_m5, Nsig_b_m5);
    Float_t AFB_fb_p5 = AFB_N_calculation(Nsig_f_p5, Nsig_b_p5);
    cout << "AFB from FB -5% = " << AFB_fb_m5 << endl;
    cout << "AFB from FB +5% = " << AFB_fb_p5 << endl;
