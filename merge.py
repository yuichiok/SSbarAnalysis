...
outROOT  = os.path.join(outDir, f'rv02-02.sv02-02.mILD_l5_o1_v02.E250-SetA.I{processID}.{args.process}.{chiralDot}.cc.KPiLPFO.dedxPi.PFOp15.LPFOp15_pNaN.all.yevhenii.root')
