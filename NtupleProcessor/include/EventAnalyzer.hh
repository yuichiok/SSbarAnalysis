...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  // Declaration of leaf types
    ...
    Int_t           pfo_n_j2;
    Int_t           jet_nvtx_j2;
    Int_t           pfo_match[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_truejet_pdg[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_truejet_type[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_pdgcheat[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_nparents[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_pdgcheat_parent[MAX_NPARTICLES][MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_E[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_E_calo[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_px[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_py[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pz[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_m[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_type[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_isoverlay[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_isisr[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_vtx[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_charge[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_ntracks[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_tpc_hits[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_dedx[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_dedxerror[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_d0[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_d0error[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_z0[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_z0error[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_phi[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_phierror[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_omega[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_omegaerror[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_tanlambda[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_tanlambdaerror[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_chi2[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_ndf[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_vtxpt[MAX_NPARTICLES][3];   //[pfo_n]
    Float_t         pfo_endpt[MAX_NPARTICLES][3];   //[pfo_n]
    Int_t           pfo_pid[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_likelihood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_eprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_muprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_piprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_kprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_pprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pid_hprob[MAX_NPARTICLES];   //[pfo_n]
    Int_t           pfo_piddedx[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_likelihood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_eprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_muprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_piprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_kprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_pprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_hprob[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_e_dedxdist[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_mu_dedxdist[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_pi_dedxdist[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_k_dedxdist[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_p_dedxdist[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_e_lkhood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_mu_lkhood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_pi_lkhood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_k_lkhood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_piddedx_p_lkhood[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_p_at_calo[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closest_beta_0ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closest_beta_10ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closest_beta_50ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closest_beta_100ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_fastest_beta_0ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_fastest_beta_10ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_fastest_beta_50ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_fastest_beta_100ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_cylfit_beta_0ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_cylfit_beta_10ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_cylfit_beta_50ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_cylfit_beta_100ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closestfit_beta_0ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closestfit_beta_10ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closestfit_beta_50ps[MAX_NPARTICLES];   //[pfo_n]
    Float_t         pfo_pidtof_closestfit_beta_100ps[MAX_NPARTICLES];   //[pfo_n]
