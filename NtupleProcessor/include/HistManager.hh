...
namespace QQbarAnalysis
{
  class HistManager
  {
    ...
    // h1 hist
      ...
      unordered_map<TString, unordered_map< TString, unordered_map< TString, unordered_map< TString, unordered_map< TString, TH1F* > > > > > h1_eff;  // [QQ_mode][GenReco][LPFO][hist][cut]
      unordered_map<TString, unordered_map< TString, unordered_map< TString, unordered_map< TString, unordered_map< TString, TH2F* > > > > > h2_eff;  // [QQ_mode][GenReco][LPFO][hist][cut]
